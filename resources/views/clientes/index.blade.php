...
<div class="d-flex">
    ...
    <div class="flex-grow-1">
        ...
        <div class="container">
            <h1>Clientes</h1>
            <h5>Cadastros > Clientes</h5>
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Clientes</h6>
                    <a href="{{ route('clientes.create') }}" class="btn btn-primary col-md-4 offset-md-8" style="margin: 10px !important">Novo Cliente</a>

                </div>
                
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table " id="tabela-clientes" width="100%" cellspacing="0">
                            <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>Nome</th>
