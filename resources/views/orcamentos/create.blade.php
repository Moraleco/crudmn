...
@section('content')
        ...
        <div class="container">
            <div class="">
                    ...
                    <form action="{{ route('orcamentos.store') }}" method="POST">
                        ...
                        <div class="card shadow-lg mb-4 border-left-primary">
                            ...
                            <div class="card-body">
                                <div id="servicos-container">
                                    <div class="row servico-item">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="servicos[0][descricao]" class="form-control" required>
                                        </div>
                                        <div class="col-md-4">
                                            <label>Valor:</label>
                                            <input type="number" name="servicos[0][valor]" class="form-control" step="0.01"
                                            value="0.00" required>
                                        </div>
                                ...
                                <button type="button" class="btn btn-primary mt-3" id="add-servico">+ Adicionar
                                    Serviço</button>
                            </div>
                        </div>
                ...
                `;
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="form-group col-md-2">
                                                ...
                                                id="valor_do_servico" value="0.00">
                                                <input type="hidden" name="valor_do_servico" id="valor_do_servico_hidden" value="0.00">
                                            </div>
                        ...
                        <!-- Botões -->
                        <div class="row">
                            <button type="submit" class="btn btn-success col-md-4 offset-md-8 py-3">Salvar
                                Orçamento</button>
                        </div>
                    </form>
                </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.getElementById("servicos-container").addEventListener("input", function (event) {
                if (event.target.name.includes("[valor]")) {
