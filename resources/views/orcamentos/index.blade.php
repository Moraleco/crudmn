                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu animated--fade-in" aria-labelledby="dropdownMenuButton">
                                                            <a class="dropdown-item"
                                                                href="{{ route('orcamentos.show', $orcamento) }}">Detalhes</a>
                                                            <a class="dropdown-item"
                                                                href="{{ route('orcamentos.edit', $orcamento) }}">Editar</a>
                                                            <a class="dropdown-item" href="#" data-toggle="modal"
                                                                data-target="#confirmDeleteModal-{{ $orcamento->id }}">Excluir</a>
                                                            <a class="dropdown-item" href="{{ route('orcamentos.pdf', $orcamento) }}">Gerar
                                                                PDF</a>
                                                        </div>
                                                    </div>
